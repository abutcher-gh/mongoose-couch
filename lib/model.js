...
Model.discriminator = function discriminator (name, schema) {
  ...
  (function mergeSchemas(schema, baseSchema) {
    ...
    (function validateOptions(a, b) {
      ...
      delete a.toObject;
      delete a.views;
      delete a.forcePlainDiscriminatorIndex;
      delete b.toJSON;
      delete b.toObject;
      delete b.views;
      delete b.forcePlainDiscriminatorIndex;

      if (!utils.deepEqual(a, b)) {
        throw new Error("Only toJSON, toObject, indexes and forcePlainDiscriminatorIndex are customizable on discriminator schemas");
      }
